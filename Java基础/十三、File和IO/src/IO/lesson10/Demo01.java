...
public class Demo01 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        //需求：拷贝文件，a.txt -> b.txt
        FileReader fr = new FileReader("E:/Java复习项目/Java复习代码/Java基础/十三、File和IO/src/IO/lesson10/a.txt");
        BufferedReader br = new BufferedReader(fr);

        //2.创建writer
        FileWriter fw = new FileWriter("E:/Java复习项目/Java复习代码/Java基础/十三、File和IO/src/IO/lesson10/b.txt");
